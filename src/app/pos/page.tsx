  ...
  return (
    <div className="flex h-screen flex-col lg:flex-row bg-gray-50 overflow-hidden font-sans selection:bg-orange-200 relative">
      ...
      <Dialog open={isPaymentModalOpen} onOpenChange={setIsPaymentModalOpen}>
        <DialogContent className="sm:max-w-2xl p-0 overflow-y-auto rounded-2xl border-0 shadow-2xl bg-gray-50 max-h-[90vh]">
          <form onSubmit={processPayment}>
            <div className="p-4 pr-12 bg-white border-b flex justify-between items-center sticky top-0 z-20">
            ...
            <div className="p-4 bg-white border-t flex gap-3 sticky bottom-0 z-20">
